...
func tableSlackConversation() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			// Other columns
			{Name: "created", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Created").Transform(jsonTimeToTime), Description: "Time when the conversation was created."},
			...
			{Name: "purpose_last_set", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Purpose.LastSet").Transform(jsonTimeToTime), Description: "Time when the purpose was last set."},
			...
			{Name: "topic_last_set", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Topic.LastSet").Transform(jsonTimeToTime), Description: "Time when the topic was last set."},
